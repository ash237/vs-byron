	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'byron':
				...
				animation.addByPrefix('singRIGHT', 'Byron_Right_Note', 24);
			...
			case 'byronMad':
				...
				animation.addByPrefix('singRIGHT', 'Angry_Byron_Right', 24);
				animation.addByPrefix('singDOWN', 'Angry_Byron_Down', 24);
				animation.addByPrefix('singLEFT', 'Angry_Byron_Left', 24);
